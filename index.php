...
<html lang="en">
  ...
  <body>
    <div class="container bg-light">
        ...
        <h6 class="text-center">Manarat International University</h6>
        <div class="row d-flex justify-content-center align-items-center align-self-center " style="height: 100vh;"> 
            <div class="box1 border border-success m-1 bg-white" style="max-width: 18rem;">
                <div class="card-body">
                    <a href="food/index.php"><img src="image/home.png" alt="img" class="img-fluid"></a>
                </div>
            ...
            <div class="box2 border border-dark m-1 bg-white" style="max-width: 18rem;">
                <div class="card-body">
                    <a href="exam/index.php"><img src="image/home.png" alt="img" class="img-fluid"></a>
                </div>
            ...
            <div class="box3 border border-info m-1 bg-white" style="max-width: 18rem;">
                <div class="card-body">
                    <a onclick="alert('You can see class and food')" href="#"><img src="image/home.png" alt="img" class="img-fluid"></a>
                </div>
